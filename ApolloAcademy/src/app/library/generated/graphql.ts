...
export type IGetAllBooksQueryGql = (
  { __typename?: 'Query' }
  & { books: Array<(
	{ __typename?: 'Book' }
	& IAllBookFieldsFragment
  )> }
);
...
export type IAllBookFieldsFragment = (
  { __typename?: 'Book' }
  & Pick<IBook, 'id' | 'title' | 'author' | 'releaseYear'>
);
...
export type ICreateBookMutationGql = (
  { __typename?: 'Mutation' }
  & { addOne: (
	{ __typename?: 'Book' }
	& Pick<IBook, 'id' | 'title'>
...
export type IUpdateReleaseInfoMutationGql = (
  { __typename?: 'Mutation' }
  & { setReleaseInfo: (
	{ __typename?: 'Book' }
	& Pick<IBook, 'id' | 'author' | 'releaseYear'>
  ) }
);

export const AllBookFieldsFragmentDoc = gql`
...
@Injectable({
  ...
  export class IUpdateReleaseInfoGQL extends Apollo.Mutation<IUpdateReleaseInfoMutationGql, IUpdateReleaseInfoMutationVariables> {
...
@Injectable()
  export class LibraryService {
	...
	getAllBooksWatch(variables?: IGetAllBooksQueryVariables, options?: WatchQueryOptionsAlone<IGetAllBooksQueryVariables>) {
	...
	createBook(variables: ICreateBookMutationVariables, options?: MutationOptionsAlone<ICreateBookMutationGql, ICreateBookMutationVariables>) {
		return this.iCreateBookGql.mutate(variables, options);
	}

	updateReleaseInfo(variables: IUpdateReleaseInfoMutationVariables, options?: MutationOptionsAlone<IUpdateReleaseInfoMutationGql, IUpdateReleaseInfoMutationVariables>) {
